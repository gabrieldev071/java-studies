public class Vectores {
    ...
    int [] notas = new int [10];  //array do tipo inteiro, chaves indica que é um array, nome da var, operador de atribuição, new cria uma instancia desse array, [10] declara o tamanho (quando vazio, precisa declarar)
